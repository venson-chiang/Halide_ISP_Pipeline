#ifndef HALIDE__bin___host___trace_all___camera_pipe_h
#define HALIDE__bin___host___trace_all___camera_pipe_h
#include <stdint.h>
...
int camera_pipe(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_matix_3200_buffer, struct halide_buffer_t *_matrix_7000_buffer, float _color_temp, float _gamma, float _contrast, float _sharpen_strenght, int32_t _blackLevel, int32_t _whiteLevel, struct halide_buffer_t *_processed_buffer);
